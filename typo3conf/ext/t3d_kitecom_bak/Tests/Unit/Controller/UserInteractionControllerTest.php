...
/**
 * Test case for class Tx_T3d_kitecom_Controller_UserInteractionController.
 *
 * @version $Id$
 ...
 */
class UserInteractionControllerTest extends \TYPO3\CMS\Extbase\Tests\Unit\BaseTestCase {
	/**
	 * @var 
	 */
	protected $fixture;
