...
class SchuleTest extends \TYPO3\CMS\Extbase\Tests\Unit\BaseTestCase {
	 ...
	 * @test
	 */
	public function getSprachenReturnsInitialValueForInteger() { 
		$this->assertSame(
			0,
	 ...
	 * @test
	 */
	public function setSprachenForIntegerSetsSprachen() { 
		$this->fixture->setSprachen(12);
	 ...
	 * @test
	 */
	public function getZeitenReturnsInitialValueForInteger() { 
		$this->assertSame(
			0,
	 ...
	 * @test
	 */
	public function setZeitenForIntegerSetsZeiten() { 
		$this->fixture->setZeiten(12);
