...
$TCA['tx_t3dkitecom_domain_model_zeiten'] = array(
	'ctrl' => $TCA['tx_t3dkitecom_domain_model_zeiten']['ctrl'],
	'interface' => array(
	...
	'columns' => array(
		...
		'l10n_parent' => array(
			...
			'config' => array(
				...
				'foreign_table_where' => 'AND tx_t3dkitecom_domain_model_zeiten.pid=###CURRENT_PID### AND tx_t3dkitecom_domain_model_zeiten.sys_language_uid IN (-1,0)',
			),
		),
		...
		'name' => array(
			'exclude' => 0,
			'label' => 'LLL:EXT:t3d_kitecom/Resources/Private/Language/locallang_db.xlf:tx_t3dkitecom_domain_model_zeiten.name',
			'config' => array(
				'type' => 'input',
				'size' => 30,
				'eval' => 'trim,required'
