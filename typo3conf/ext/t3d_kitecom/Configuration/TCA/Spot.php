...
$TCA['tx_t3dkitecom_domain_model_spot'] = array(
	...
	'interface' => array(
		'showRecordFieldList' => 'sys_language_uid, l10n_parent, l10n_diffsource, hidden, name, ort, stadt, land, anfaenger, fortgeschrittene, profis, hauptbild, flachwasser, rettungsdienst, wellen, schule, parkplatz, startlandehilfe, grossereinstieg, sandplatz, wc, stehrevier, beschreibung, regeln, lat, lng, webcam, crfeuser',
	),
	'types' => array(
		'1' => array('showitem' => 'sys_language_uid;;;;1-1-1, l10n_parent, l10n_diffsource, hidden;;1, name, ort, stadt, land, anfaenger, fortgeschrittene, profis, hauptbild, flachwasser, rettungsdienst, wellen, schule, parkplatz, startlandehilfe, grossereinstieg, sandplatz, wc, stehrevier, beschreibung, regeln, lat, lng, webcam, crfeuser,--div--;LLL:EXT:cms/locallang_ttc.xlf:tabs.access,starttime, endtime'),
	),
	'palettes' => array(
		'1' => array('showitem' => ''),
	),
	'columns' => array(
		...
		'crfeuser' => array(
			'exclude' => 0,
			'label' => 'LLL:EXT:t3d_kitecom/Resources/Private/Language/locallang_db.xlf:tx_t3dkitecom_domain_model_spot.crfeuser',
			'config' => array(
				'type' => 'input',
				'size' => 4,
				'eval' => 'int'
