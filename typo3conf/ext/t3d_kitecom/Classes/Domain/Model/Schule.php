...
class Schule extends \TYPO3\CMS\Extbase\DomainObject\AbstractEntity {
	 ...
	 * Zeiten
	 *
	 * @var \TYPO3\CMS\Extbase\Persistence\ObjectStorage<\kitecom\T3dKitecom\Domain\Model\Zeiten>
	 * @lazy
	 */
	protected $zeiten;
	 ...
	 * Unterrichtssprachen
	 *
	 * @var \TYPO3\CMS\Extbase\Persistence\ObjectStorage<\kitecom\T3dKitecom\Domain\Model\Sprachen>
	 * @lazy
	 */
	protected $sprachen;
	...
	protected function initStorageObjects() {
		...
		$this->sprachen = new \TYPO3\CMS\Extbase\Persistence\ObjectStorage();
	}

	/**
	 * Adds a Zeiten
	 *
	 * @param \kitecom\T3dKitecom\Domain\Model\Zeiten $zeiten
	 * @return void
	 */
	public function addZeiten(\kitecom\T3dKitecom\Domain\Model\Zeiten $zeiten) {
		$this->zeiten->attach($zeiten);
	}

	/**
	 * Removes a Zeiten
	 *
	 * @param \kitecom\T3dKitecom\Domain\Model\Zeiten $zeitenToRemove The Zeiten to be removed
	 * @return void
	 */
	public function removeZeiten(\kitecom\T3dKitecom\Domain\Model\Zeiten $zeitenToRemove) {
		$this->zeiten->detach($zeitenToRemove);
	}

	/**
	 * Returns the zeiten
	 *
	 * @return \TYPO3\CMS\Extbase\Persistence\ObjectStorage<\kitecom\T3dKitecom\Domain\Model\Zeiten> $zeiten
	 */
	 ...
	 * Sets the zeiten
	 *
	 * @param \TYPO3\CMS\Extbase\Persistence\ObjectStorage<\kitecom\T3dKitecom\Domain\Model\Zeiten> $zeiten
	 * @return void
	 */
	public function setZeiten(\TYPO3\CMS\Extbase\Persistence\ObjectStorage $zeiten) {
		$this->zeiten = $zeiten;
	}
	 ...
	 * Adds a Sprachen
	 *
	 * @param \kitecom\T3dKitecom\Domain\Model\Sprachen $sprachen
	 * @return void
	 */
	public function addSprachen(\kitecom\T3dKitecom\Domain\Model\Sprachen $sprachen) {
	 ...
	 * Removes a Sprachen
	 *
	 * @param \kitecom\T3dKitecom\Domain\Model\Sprachen $sprachenToRemove The Sprachen to be removed
	 * @return void
	 */
	public function removeSprachen(\kitecom\T3dKitecom\Domain\Model\Sprachen $sprachenToRemove) {
	 ...
	 *
	 * @return \TYPO3\CMS\Extbase\Persistence\ObjectStorage<\kitecom\T3dKitecom\Domain\Model\Sprachen> $sprachen
	 */
	 ...
	 * Sets the sprachen
	 *
	 * @param \TYPO3\CMS\Extbase\Persistence\ObjectStorage<\kitecom\T3dKitecom\Domain\Model\Sprachen> $sprachen
	 * @return void
	 */
